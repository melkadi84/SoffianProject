...
class AppConfiguration(models.Model):
    # Artisan Promise
    artisan_promise_title_en = models.CharField(max_length=200, default="Discover Handcrafted Masterpieces")
...
class Review(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        reviews = self.product.product_reviews.all()
        self.product.review_count = reviews.count()
        avg_rating = reviews.aggregate(models.Avg('rating'))['rating__avg']
        self.product.rating = avg_rating if avg_rating is not None else 4.5
        self.product.save()
